...
class Crawler_paging {
	...
	var $next_link			= '&nbsp;&nbsp;kế tiếp';
	var $prev_link			= 'về trước&nbsp;';
	...
	var $cur_tag_open		= '&nbsp;<span class=\'btn btn-success btn-xs\'>';
  ...
  var $query_string_segment = 'page';
	...
	function create_links()
	{
				...
				if ($i >= $base_page)
				{
					...
					else
					{
						...
						else
						{
							...
							$output .= $this->num_tag_open.'<a '.'title = "trang '.$loop.'"'.$this->anchor_class.'href="'.$this->base_url.$n.'">'.$loop.'</a>'.$this->num_tag_close;
						}
					}
				}
			}
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a '.'title = "trang'.$this->next_link.'"'.$this->anchor_class.'href="'.$this->base_url.$this->prefix.$i.$this->suffix.'">'.$this->next_link.'</a>'.$this->next_tag_close;
		}
